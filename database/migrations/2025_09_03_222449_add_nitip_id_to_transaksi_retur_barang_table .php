...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::table('transaksi_retur_barang', function (Blueprint $table) {
            $table->mediumText('bukti_tf')->nullable();
            $table->string('tgl_transaksi_retur_barang')->nullable();
        ...
        Schema::table('transaksi_retur_barang_detail', function (Blueprint $table) {
    ...
    public function down()
    {
        Schema::table('transaksi_retur_barang', function (Blueprint $table) {
            ...
            $table->dropColumn('tgl_transaksi_retur_barang');
